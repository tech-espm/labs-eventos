...
$.fn.dataTable.ext.type.order["customdate-pre"] = (window.currentLanguageId === 1 ? function (d) {
	...
	day = parseInt(d.substring(s1 + 1, s2));
	month = monthsToInt[d.substring(0, s1)];
	...
	if (s <= 0 || s2 <= s)
		return -2147483648;
	year = parseInt(d.substring(s2 + 1));
	month = monthsToInt[d.substring(s1 + 1, s2)];
	day = parseInt(d.substring(0, s1));
	return ((isNaN(year) || isNaN(month) || isNaN(day)) ? -2147483648 : ((year * 10000) + (month * 100) + day));
});
...
$.fn.dataTable.ext.type.order["customdateint-pre"] = (window.currentLanguageId === 1 ? function (d) {
	...
	year = parseInt(d.substring(s2 + 1));
	day = parseInt(d.substring(s1 + 1, s2));
	month = parseInt(d.substring(0, s1));
	return ((isNaN(year) || isNaN(month) || isNaN(day)) ? -2147483648 : ((year * 10000) + (month * 100) + day));
} : function (d) {
	if (!d)
		return -2147483648;
	...
	if (s <= 0 || s2 <= s)
		return -2147483648;
	year = parseInt(d.substring(s2 + 1));
	month = parseInt(d.substring(s1 + 1, s2));
	day = parseInt(d.substring(0, s1));
	return ((isNaN(year) || isNaN(month) || isNaN(day)) ? -2147483648 : ((year * 10000) + (month * 100) + day));
});
