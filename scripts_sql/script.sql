...
CREATE TABLE evento (
  ...
  certificadoliberado tinyint NOT NULL,
  permiteinscricao tinyint NOT NULL,
  aspectratioempresa varchar(16) DEFAULT NULL,
  aspectratiopalestrante varchar(16) DEFAULT NULL,
  permitealuno tinyint NOT NULL,
  permitefuncionario tinyint NOT NULL,
  permiteexterno tinyint NOT NULL,
...
CREATE TABLE eventosessao (
  ...
  url_privada tinyint NOT NULL,
  descricao varchar(2000) NOT NULL,
  oculta tinyint NOT NULL,
  sugestao tinyint NOT NULL,
  publico_alvo varchar(100) NOT NULL,
  tags varchar(100) NOT NULL,
  permiteinscricao tinyint NOT NULL,
  permitesimultanea tinyint NOT NULL,
  ...
  tipomultidata tinyint NOT NULL,
  presencaminima tinyint NOT NULL,
  encontrostotais tinyint NOT NULL,
  id_integra bigint NOT NULL,
  status_integra tinyint NOT NULL,
  PRIMARY KEY (id),
...
CREATE TABLE eventosessaoavaliacao (
  id bigint NOT NULL AUTO_INCREMENT,
  ideventosessaoparticipante bigint NOT NULL,
  conhecimento tinyint NOT NULL,
  conteudo tinyint NOT NULL,
  pontualidade tinyint NOT NULL,
  aplicabilidade tinyint NOT NULL,
  expectativas tinyint NOT NULL,
